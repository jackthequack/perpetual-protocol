...
contract TollPool is DecimalERC20 {
    ...
    // FUNCTIONS
    //
    function initialize(address _clearingHouse, ClientBridge _clientBridge) external {
    ...
    function setFeeTokenPoolDispatcher(address _feeTokenPoolDispatcherL1) external {
    ...
    function addFeeToken(IERC20 _token) external {
    ...
    function removeFeeToken(IERC20 _token) external {
