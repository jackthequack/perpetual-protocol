...
contract RewardsDistribution is BlockContext, DecimalERC20 {
    ...
    function initialize(address _rewardsController, IRewardRecipient _defaultRecipient) public  {
    ...
    function distributeRewards(IERC20 _perpToken, Decimal.decimal memory _amount) public {
        require(msg.sender == rewardsController, "!_rewardsController");
    ...
    function addRewardsDistribution(address _destination, Decimal.decimal memory _amount) public {
    ...
    function removeRewardsDistribution(uint256 _index) external {
