...
contract InflationMonitor is IInflationMonitor, BlockContext, DecimalERC20 {
    ...
    function initialize(IMinter _minter) public {
        minter = _minter;
        shutdownThreshold = Decimal.one().divScalar(10);
    }

    function setShutdownThreshold(Decimal.decimal memory _shutdownThreshold) public {
